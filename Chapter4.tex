...
indexing under an open-source license\cite{chroma_docs_2025}. A critical feature is its ability
...
\begin{center}
\begin{figure}[H]
    \includegraphics[scale=0.45]{images/chroma_space.png}
...
\begin{center}
\begin{figure}[H]
    \includegraphics[scale=0.55]{images/VN_recommendation.png}
...
\par Our API provides a single endpoint, /recommend, which receives structured input from the app (user ID, scanned EAN,limit, recommendation\_type) and returns tailored food item suggestions in JSON format.
